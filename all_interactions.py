...
def _(mo):
    mo.md(r"""
    ## importing data and making interaction table
    """)
    return
...
def _(mo):
    mo.md(r"""
    importing ligand receptor archetpe pair table
    """)
    return
...
def _(mo):
    mo.md(r"""
    makeing a pairwise interaction table
    """)
    return
...
def _(mo):
    mo.md(r"""
    importing tissue correlation data
    """)
    return
...
def _(mo):
    mo.md(r"""
    multipying the tissue and pairs to get correlation map
    """)
    return
...
def _(interactions, lr_df, pd, tissues):
    ligand_by_cell_type = (
        ...
        .condense()
        .df.groupby(by="cell_type_ligand")["pair_weight"]  # Select the column here
        .sum()                                            # Now sum works without arguments
        .to_frame()                                       # Convert Series back to DataFrame to allow renaming
    ...
    receptor_by_cell_type = (
        ...
        .tissue_correction(tissues)
        .condense()
        .df.groupby(by="cell_type_receptor")["pair_weight"]  # Select column first
        .sum()                                              # Now sum works
...
@app.cell
def _(interactions, lr_df, tissues):
    interactions(lr_df).tissue_correction(tissues).min_mean_diff(0.3).condense().df
    return
